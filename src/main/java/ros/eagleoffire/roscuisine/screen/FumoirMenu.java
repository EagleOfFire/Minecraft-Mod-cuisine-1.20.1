...
public class FumoirMenu extends AbstractContainerMenu {
    public final FumoirBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public FumoirMenu(int pContainerID, Inventory inv, FriendlyByteBuf extraData){
